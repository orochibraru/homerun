...
| `auth.origin`                                        | `ORIGIN` env, else derived per-request                 | General, this app's own public origin; required for the per-app login wall, which sends visitors here to sign in             |
