...
// version is the release this binary was built from, stamped in at build time
// by scripts/build-packages.ts (-ldflags "-X main.version=..."), so there's one
// number for the whole repo and no file read at runtime.
var version = "dev"
