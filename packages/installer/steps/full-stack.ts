...
# here to update. AUTH_SECRET is auto-generated into the .env file next to
# this compose.yaml the first time this installer runs (see
# steps/auth-secret.ts) ; set the other vars there too if you want non-default
# values.
services:
  app:
    image: ${image}
