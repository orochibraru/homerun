    ...
    <div class="mx-auto flex items-center justify-between px-6 py-4">
        ...
        <nav class="flex items-center gap-6 text-sm">
            ...
            <a
                ...
                class="transition-colors hover:text-(--text) {current === 'docs'
                    ? 'text-(--text)'
                    : 'text-(--text-muted)'}">Docs</a
            >
            <a
            ...
            <button
                ...
                class="flex size-8 cursor-pointer items-center justify-center rounded-full border border-(--border) text-(--text-muted) transition-colors hover:border-(--border-hover) hover:text-(--text)"
            >
