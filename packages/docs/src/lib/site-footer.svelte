<footer class="border-t border-(--border) py-10">
  <div
    class="mx-auto flex max-w-6xl flex-col items-center gap-3 px-6 text-center text-sm text-(--text-subtle) sm:flex-row sm:justify-between sm:text-left"
  >
    <p>Homerun is source-available, self-hosted software. Run it on your own box.</p>
