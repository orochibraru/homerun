...
>
  <textarea
    bind:value={text}
    class="h-48 w-full resize-none rounded-lg panel p-3 font-mono text-xs text-text placeholder:text-text-muted focus:outline-none focus:ring-2 focus:ring-accent"
